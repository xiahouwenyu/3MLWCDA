...
class ResponseMetaData:
    ...
    def get_energy_bkg_hist(
        ...
        energy_bkg_prefix = f"dec_{dec_id:02d}/nh_{bin_id}/EnSig_dec{dec_id}_nh{bin_id}"
    ...
    def get_psf_params(
        ...
        if response_ttree_directory.get(psf_prefix, None) is not None:
            ...
            return dec_id, bin_id, psf_meta.member("fFormula").member("fClingParameters")  # type: ignore
    ...
    def log_log_params(self) -> ndarray:
        ...
        if self.response_ttree_directory.get("LogLogSpectrum", None) is not None:
            return np.array(
                ...
                self.response_ttree_directory["LogLogSpectrum"].member("fFormula").member("fClingParameters")  # type: ignore
            )
    ...
    def spectrum_shape(self) -> str:
        ...
        if self.response_ttree_directory.get("LogLogSpectrum", None) is not None:
            ...
            # return self.response_ttree_directory["LogLogSpectrum"].member("fFormula").member("fTitle")  # type: ignore
